...
export const metadata: Metadata = {
  ...
  description: `SpeedPad release history: ${CURRENT_VERSION} (${EXE_SIZE}). Download the latest EXE/ZIP, view changelogs, and track 84 releases from v1.0 to today.`,
  openGraph: {
    title: `SpeedPad Release Center — ${CURRENT_VERSION}`,
    description: `Download SpeedPad ${CURRENT_VERSION} and browse the complete release timeline. 84 releases, every one under 1MB.`,
  },
};
