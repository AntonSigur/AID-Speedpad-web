...
const teamData: TeamMember[] = [
  ...
  },
  {
    ...
    achievements: [
      "Coordinated 27+ sprints from planning to delivery",
  ...
  },
  {
    ...
    achievements: [
      "Created the \u002720 Things Only SpeedPad Can Do\u0027 list",
      "Defined 40+ features for the SpeedPad v2 roadmap",
  ...
  },
  {
    ...
    achievements: [
      ...
      "Kept binary under 820KB across 29+ releases",
    ],
  ...
  },
  {
    ...
    achievements: [
      ...
      "Maintained 54/55 test suite with 400+ assertions",
    ],
  ...
  },
  {
    ...
    achievements: [
      "Built 7-page marketing site from scratch",
      "Created responsive dark theme with IT Ant branding",
      "140+ feature showcase with comparison tables",
