...
const jsonLd = {
  ...
  numberOfItems: 28,
  itemListElement: [
    { "@type": "ListItem", position: 1, name: "v2.71.0", description: "Session Extraction + C&C Strategy — 673 tests, 65% vision" },
    { "@type": "ListItem", position: 2, name: "v2.70.0", description: "Stabilization — F70 Rogue DLL, B221–B226 fixes, 625 tests" },
    { "@type": "ListItem", position: 3, name: "v2.69.0", description: "Background Indexing — F20 .spidx, 600 test milestone" },
    { "@type": "ListItem", position: 4, name: "v2.68.0", description: "Phase 4 Intelligence COMPLETE — F65–F69, 566 tests" },
    { "@type": "ListItem", position: 5, name: "v2.67.0", description: "Pattern Timeline + Auto-Correlator — F66/F67, 505 tests" },
    { "@type": "ListItem", position: 6, name: "v2.66.0", description: "HexCompare + 500 test milestone — 504 tests" },
    { "@type": "ListItem", position: 7, name: "v2.65.0", description: "Multi-File Search & Code Signing — 432 tests" },
