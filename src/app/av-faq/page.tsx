...
const factors = [
  ...
  { factor: "Binary size", status: "~843 KB", note: "Small EXEs score lower in ML models" },
      ...
      <Box sx={{ py: 6, textAlign: "center" }}>
        <Container maxWidth="sm">
          ...
          <Typography variant="body1" color="text.secondary" sx={{ mb: 3 }}>
            SpeedPad is 843KB with zero dependencies. No telemetry, no network calls, no hidden behavior.
          </Typography>
