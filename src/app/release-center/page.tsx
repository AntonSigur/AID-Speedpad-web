...
const releases = [
  ...
  },
  {
    ...
    highlights: [
      ...
      "F71 C&C Strategy Game — real-time strategy mini-game DLL",
      "B227 Cursor bounds fix on session restore",
      "Test suite at 673 — 60 consecutive sprints, 65% vision",
    ],
    milestone: "Session Extraction & C&C Strategy",
  },
  {
    version: "v2.70.0",
    release: 91,
    ...
    tests: 625,
    highlights: [
      "F70 Rogue DLL — ASCII dungeon explorer",
      "B221+B224+B225+B226 stabilization fixes",
      "Test suite at 625 — 59 consecutive sprints",
    ],
  ...
  },
  {
    ...
    tests: 605,
    highlights: [
      "F20 Background Indexing — .spidx sidecar, GoToLine time-budget",
      "600 test milestone! ParseInt overflow hardening",
      "58 consecutive sprints — 60% vision milestone",
    ],
    milestone: "Background Indexing & 600 Tests",
  },
  {
    version: "v2.68.0",
    release: 89,
    ...
    tests: 566,
    highlights: [
      "PHASE 4 INTELLIGENCE COMPLETE: F65+F66+F67+F68+F69",
      "F69 Build Output Parser (F4/Shift+F4)",
      "F67 Auto-Correlator UI (Ctrl+Shift+K)",
      "B220 Bucket overflow fix — 566 test suites",
    ],
    milestone: "Phase 4 Intelligence Complete",
  },
  {
    version: "v2.67.0",
    release: 88,
    ...
    tests: 505,
    highlights: [
      "F66 Pattern Timeline — frequency visualization (Ctrl+Shift+T)",
      "F67 Auto-Correlator — event sequence detection",
      "Arkanoid Document Mode — words become bricks",
      "505 test suites — 56 consecutive sprints",
    ],
    milestone: "Pattern Timeline & Auto-Correlator",
  },
  {
    version: "v2.66.0",
    release: 87,
