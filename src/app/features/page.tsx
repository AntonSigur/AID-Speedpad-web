...
const featureGroups = [
  ...
  },
  {
    ...
    features: [
      ...
      { name: "Log Correlation", shortcut: "Ctrl+Shift+E", desc: "Link related entries across up to 8 files with timestamp sync and ⛓ indicator" },
  ...
  },
  {
    ...
    features: [
      ...
      { name: "Command Palette", shortcut: "Ctrl+Shift+P", desc: "Fuzzy-search all 91 commands with role-based filtering" },
...
const comparison = [
  { feature: "EXE Size", sp: "843 KB", npp: "14 MB", vsc: "400 MB", hxd: "3.5 MB" },
...
const uniqueFeatures = [
  ...
  "Pattern Timeline — Ctrl+Shift+T frequency visualization with click-to-jump for event pattern detection",
  "Auto-Correlator — Ctrl+Shift+K automatic event sequence detection across log files",
  "Build Output Parser — F4/Shift+F4 MSVC/GCC/Clang error navigation directly from build logs",
