      ...
      <Box sx={{ bgcolor: "background.paper", py: { xs: 4, md: 6 } }}>
        <Container maxWidth="md">
          ...
          <Typography variant="body1" color="text.secondary" sx={{ mb: 2, lineHeight: 1.8 }}>
            ...
            Like ants — we carry loads many times our own weight. SpeedPad is a 703KB executable that opens
          ...
          <Typography variant="body1" color="text.secondary" sx={{ lineHeight: 1.8 }}>
            ...
            keep SpeedPad at 703KB. That&apos;s the ant way.
          </Typography>
        </Container>
      </Box>
        ...
        <Container maxWidth="md" sx={{ textAlign: "center" }}>
          ...
          <Box sx={{ display: "grid", gridTemplateColumns: { xs: "1fr", sm: "1fr 1fr" }, gap: 3 }}>
            {[
              ...
              { title: "Zero Bloat", desc: "703KB total. No frameworks, no runtimes, no external dependencies." },
