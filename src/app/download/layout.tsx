...
export const metadata: Metadata = {
  ...
  description:
    `Download SpeedPad ${CURRENT_VERSION} (${EXE_SIZE}) and SpeedHexPad.exe — two free editors, zero dependencies. No installer needed. Windows 10+ compatible. 96 releases available.`,
  openGraph: {
