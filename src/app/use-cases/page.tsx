...
const useCases = [
  ...
  },
  {
    ...
    workflow: [
      ...
      "Ctrl+Alt+H switches to SpeedHexPad hex view to inspect a suspicious binary attachment",
  ...
  },
  {
    ...
    workflow: [
      "Open the firmware binary in SpeedPad, press Ctrl+Alt+H to enter hex view",
    ...
    features: ["SpeedHexPad", "Binary Inspector", "Endianness Toggle", "Hex Search"],
    link: "/hex-editor",
    linkLabel: "SpeedHexPad Details →",
    color: "#00BCD4",
  },
