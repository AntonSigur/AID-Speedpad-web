...
export const metadata: Metadata = {
  ...
  description:
    "Complete version history for SpeedPad. Every feature, bug fix, and test improvement across 84 releases — from v2.30.0 to v2.63.0.",
  openGraph: {
    title: "SpeedPad Changelog — Visual Version Timeline",
    description: "Track every SpeedPad release: features, bug fixes, and test suite growth from 153 to 393 tests.",
  },
};
...
const jsonLd = {
  ...
  numberOfItems: 22,
  itemListElement: [
    { "@type": "ListItem", position: 1, name: "v2.63.0", description: "Structure Templates & Data Bookmarks — 393 tests" },
