...
export const metadata: Metadata = {
  title: "Command Explorer — SpeedPad | 96 Commands, Role-Filtered",
  description:
  ...
  openGraph: {
    title: "SpeedPad Command Explorer — 96 Commands for Every Workflow",
    description:
...
const jsonLd = {
  ...
  itemListElement: [
    ...
    { "@type": "ListItem", position: 5, name: "Command Palette", description: "Ctrl+Shift+P — Fuzzy-search all 96 commands with role filtering" },
  ],
};
