        ...
        <Grid container spacing={4}>
          <Grid size={{ xs: 12, md: 4 }}>
            ...
            <Typography variant="body2" color="text.secondary" sx={{ maxWidth: 280 }}>
              A blazing-fast 843KB Windows text editor. Opens 100GB+ files instantly. Built by IT Ant ehf.
            </Typography>
          </Grid>
          <Grid size={{ xs: 6, md: 2 }}>
          ...
          <Grid size={{ xs: 12, md: 4 }}>
            ...
            <Typography variant="body2" color="text.secondary">v2.75.0 · 843KB · 180+ features · 1,052 tests · 96 releases</Typography>
            <Typography variant="body2" color="text.secondary">55 unique features no other editor has · 1,000+ test milestone</Typography>
          </Grid>
        </Grid>
