      ...
      <Container maxWidth="lg">
        ...
        <Box sx={{ mt: 8 }}>
          ...
          {[
            ...
            { q: "Do I need to install anything or configure a server?", a: "No. SpeedPad is a single 843KB EXE with zero dependencies. Download, double-click, open files. No installer, no runtime, no configuration, no cloud account." },
            ...
            { q: "How does Multi-File Search help during incidents?", a: "Press Ctrl+Alt+F to pick a directory, then search all files in parallel. Results stream in with file names and line numbers — ideal for scanning an entire /var/log/ directory for error patterns without opening files one by one." },
          ].map((item, i) => (
        ...
        <Box sx={{ textAlign: "center", mt: 6 }}>
          ...
          <Typography variant="body1" color="text.secondary" sx={{ mb: 3 }}>
            Download SpeedPad (843KB) and run through any scenario on your own logs.
          </Typography>
          <Box sx={{ display: "flex", gap: 2, justifyContent: "center", flexWrap: "wrap" }}>
            <Button
              variant="contained"
