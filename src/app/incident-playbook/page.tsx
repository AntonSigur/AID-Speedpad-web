...
const scenarios: Scenario[] = [
  {
    ...
    steps: [
      ...
      { key: "Ctrl+Shift+C", action: "Log Correlation (View)", detail: "Link entries across up to 8 service logs by timestamp. Click ⛓ indicators to jump between correlated events." },
      ...
      <Container maxWidth="lg">
        ...
        <Box sx={{ mt: 8 }}>
          ...
          {[
            ...
            { q: "How does Log Correlation work across files?", a: "The Log Correlation Engine (Ctrl+Shift+C in View mode) links entries across up to 8 files by matching timestamps. Clickable chain (⛓) indicators let you jump between correlated events across services." },
            { q: "Do I need to install anything or configure a server?", a: "No. SpeedPad is a single 828KB EXE with zero dependencies. Download, double-click, open files. No installer, no runtime, no configuration, no cloud account." },
        ...
        <Box sx={{ textAlign: "center", mt: 6 }}>
          ...
          <Typography variant="body1" color="text.secondary" sx={{ mb: 3 }}>
            Download SpeedPad (828KB) and run through any scenario on your own logs.
          </Typography>
          <Box sx={{ display: "flex", gap: 2, justifyContent: "center", flexWrap: "wrap" }}>
            <Button
              variant="contained"
