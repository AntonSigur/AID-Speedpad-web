      ...
      <Box id="getting-started" sx={{ bgcolor: "background.paper", py: { xs: 4, md: 8 } }}>
        <Container maxWidth="md">
          ...
          <Typography variant="body1" color="text.secondary" sx={{ mb: 3, lineHeight: 1.8 }}>
            ...
            and run it. That&apos;s it. SpeedPad is a single 956KB executable with zero external dependencies.
          </Typography>
          ...
          <Typography variant="body1" color="text.secondary" sx={{ lineHeight: 1.8 }}>
            Press <strong>Ctrl+Shift+P</strong> to access all 96 commands with fuzzy search.
        ...
        <Grid container spacing={3}>
          {[
            ...
            },
            {
              ...
              desc: "Pure Win32 API + C++17 standard library. No frameworks, no runtimes, no package managers. The entire editor compiles to a single 956KB EXE that runs on Windows 7 through 11.",
            },
          ].map((item) => (
