...
export const metadata: Metadata = {
  ...
  description:
    "Real-world use cases for SpeedPad: DevOps incident triage, security log forensics, data analysis on large CSVs, binary inspection, and developer workflows — all in 843KB.",
  openGraph: {
