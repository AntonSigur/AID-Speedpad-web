...
export const metadata: Metadata = {
  ...
  description:
    "Complete keyboard shortcut reference for SpeedPad. 85+ shortcuts across 9 categories: editing, navigation, view modes, search, multi-file, multi-cursor, and log analysis.",
  openGraph: {
...
const jsonLd = {
  ...
  description: "85+ keyboard shortcuts for SpeedPad text editor across 9 categories",
  step: [
    ...
    { "@type": "HowToStep", name: "Command Palette", text: "Ctrl+Shift+P — Fuzzy-search all 110 commands" },
  ],
};
