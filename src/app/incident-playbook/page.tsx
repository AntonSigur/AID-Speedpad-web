      ...
      <Container maxWidth="lg">
        ...
        <Box sx={{ mt: 8 }}>
          ...
          {[
            ...
            { q: "Do I need to install anything or configure a server?", a: "No. SpeedPad is a single 758KB EXE with zero dependencies. Download, double-click, open files. No installer, no runtime, no configuration, no cloud account." },
        ...
        <Box sx={{ textAlign: "center", mt: 6 }}>
          ...
          <Typography variant="body1" color="text.secondary" sx={{ mb: 3 }}>
            Download SpeedPad (758KB) and run through any scenario on your own logs.
          </Typography>
          <Box sx={{ display: "flex", gap: 2, justifyContent: "center", flexWrap: "wrap" }}>
            <Button
              variant="contained"
