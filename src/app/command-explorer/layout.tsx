...
export const metadata: Metadata = {
  title: "Command Explorer — SpeedPad | 94 Commands, Role-Filtered",
  description:
    "Browse all 94 SpeedPad commands filtered by role: DevOps, Developer, Data Analyst, Writer, SysAdmin. Searchable, with category grouping and quick presets for incident triage, large-file navigation, and editing workflows.",
  openGraph: {
    title: "SpeedPad Command Explorer — 94 Commands for Every Workflow",
    description:
...
const jsonLd = {
  ...
  description: "94 keyboard shortcuts, CLI flags, and commands for SpeedPad text editor",
  numberOfItems: 94,
  itemListElement: [
    ...
    { "@type": "ListItem", position: 5, name: "Command Palette", description: "Ctrl+Shift+P — Fuzzy-search all 94 commands with role filtering" },
  ],
};
